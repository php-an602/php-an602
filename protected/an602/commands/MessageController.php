...
class MessageController extends \yii\console\controllers\MessageController
{
    ...
    public function actionExtractModule($moduleId)
    {
        ...
        $configFile = Yii::getAlias('@an602/config/i18n.php');
    ...
    protected function saveMessagesToPHP($messages, $dirName, $overwrite, $removeUnused, $sort, $markUnused)
    {
        ...
        foreach ($messages as $category => $msgs) {
            ...
            if ($module !== null) {
                ...
                $dirName = str_replace(Yii::getAlias("@an602/messages"), $module->getBasePath() . '/messages', $dirNameBase);
    ...
    {
        // Get Message Folders
        $messageFolders = [Yii::getAlias('@an602/messages')];
        ...
        foreach (Yii::$app->params['availableLanguages'] as $language => $name) {
            ...
            if (!is_dir(Yii::getAlias("@an602/messages/" . $language))) {
            ...
            // Load Archive
            $archive = [];
            $archiveFile = Yii::getAlias('@an602/messages/' . $language . '/archive.json');
