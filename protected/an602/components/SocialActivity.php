 ...
 * ActiveRecord.
 *
 * Since SocialActivities need to be rendered in most cases it implements the an602\components\rendering\Viewable interface and provides
...
abstract class SocialActivity extends BaseObject implements rendering\Viewable
{
     ...
     * @return \an602\components\SocialActivity
     */
     ...
     *
     * @return \an602\modules\content\models\Content Content ActiveRecord or null if not related to a ContentOwner source
     */
