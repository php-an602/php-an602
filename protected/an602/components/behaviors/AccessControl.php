 ...
 * ```
 *
 * The list of available rules is given by the [[\an602\components\access\ControllerAccess]] class set by a controller.
 * By default the base [[\an602\components\access\ControllerAccess]] class will be used.
 *
 ...
 *
 * > Note: You can also use the [[\an602\components\Controller::access]] property
