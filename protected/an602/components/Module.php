...
class Module extends \yii\base\Module
{
    ...
    public function migrate()
    {
        ...
        if (is_dir($migrationPath)) {
            \an602\commands\MigrateController::webMigrateUp($migrationPath);
        }
    }
     ...
     *
     * @since 0.21
     * @param \an602\modules\content\components\ContentContainerActiveRecord $contentContainer optional contentcontainer
