...
class Controller extends \yii\web\Controller
{
    ...
    {
        return $this->renderPartial('@an602/views/htmlRedirect.php', [
            'url' => Url::to($url)
        ]);
    }
    ...
    {
        return $this->renderPartial('@an602/views/modalClose.php', []);
    }
    ...
    public function setJsViewStatus()
    {
        ...
        $this->view->registerJs('an602.modules.ui.view.setState("' . $moduleId . '", "' . Yii::$app->controller->id . '", "' . Yii::$app->controller->action->id . '");', \yii\web\View::POS_BEGIN);

        if (Yii::$app->request->isPjax) {
            \an602\widgets\TopMenu::setViewState();
        }
    }
