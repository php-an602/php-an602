 ...
 * pjax requests.
 */
an602.module('file', function (module, require, $) {
    ...
    Upload.component = 'an602-file-upload';
    ...
    Upload.prototype.start = function (e, data) {
        ...
        this.fire('an602:file:uploadStart', [data]);
    ...
    Upload.prototype.done = function (e, response) {
        ...
        this.fire('an602:file:uploadEnd', [response]);
    ...
    Preview.component = 'an602-file-preview';
    ...
    var filterFileUrl = function(url, download) {
        ...
        if(url.indexOf('file-guid:') === 0 || url.indexOf('file-guid-') === 0) {
            ...
            result.url = an602.modules.file.getFileUrl(result.guid, download);
        }
    ...
    var init = function () {
        event.on('an602:file:created', function (evt, files) {
