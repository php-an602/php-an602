...
class LinkInviteCest
{
    public function testDisabledLinkInvite(FunctionalTester $I)
    {
        ...
        $inviteForm = new \an602\modules\space\models\forms\InviteForm();
        $inviteForm->space = \an602\modules\space\models\Space::findOne(['name' => 'Space 2']);
    ...
    public function testValidTokenDifferentSpaceId(FunctionalTester $I)
    {
        ...
        // Generate Token
        $space = \an602\modules\space\models\Space::findOne(['name' => 'Space 2']);
        $inviteForm = new \an602\modules\space\models\forms\InviteForm();
    ...
    public function testSpaceInvite(FunctionalTester $I)
    {
        ...
        $userId = \an602\modules\user\models\User::findOne(['username' => 'NewUser']);
        $space = \an602\modules\space\models\Space::findOne(['name' => 'Space 2']);
