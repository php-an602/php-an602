...
use an602\modules\user\models\forms\AccountChangeEmail;
use an602\modules\user\models\forms\AccountChangeUsername;
use an602\modules\user\models\forms\AccountDelete;
use an602\modules\user\models\Profile;
use an602\modules\user\models\User;
use an602\modules\user\widgets\ProfileSettingsAutocomplete;
use an602\modules\user\widgets\ProfileSettingsPicker;
use Yii;
...
class AccountController extends BaseAccountController
{
    ...
    public function actionEditSettings()
    {
        ...
        $model = new \an602\modules\user\models\forms\AccountSettings();
    ...
    {
        $this->subLayout = '@an602/modules/user/views/account/_userModulesLayout';
    ...
    public function actionChangeEmailValidate()
    {
        ...
        $emailAvailablyCheck = \an602\modules\user\models\User::findOne(['email' => $email]);
    ...
    public function actionChangePassword()
    {
        ...
        $userPassword = new \an602\modules\user\models\Password();
