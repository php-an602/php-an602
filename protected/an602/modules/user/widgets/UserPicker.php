 ...
 * @since 0.5
 * @deprecated since 1.2 use UserPickerField widget for rendering a picker and \an602\modules\user\models\UserPicker for search queries.
 * @author Luke
 */
class UserPicker extends \yii\base\Widget
{
    ...
    private static function createJSONUserInfo($user, $permission = null, $priority = null)
    {
        ...
        if($permission != null && $permission instanceof \an602\libs\BasePermission) {
