...
class m170110_152425_space_follow_reset_send_notification extends Migration
{
    public function up()
    {
        ...
        $this->updateSilent('user_follow', ['send_notifications' => 0], ['object_model' => \an602\modules\space\models\Space::class]);
        $this->updateSilent('user_follow', ['send_notifications' => 0], ['object_model' => \an602\modules\user\models\User::class]);
    }
