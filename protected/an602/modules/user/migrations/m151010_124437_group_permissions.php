...
class m151010_124437_group_permissions extends \an602\components\Migration
{
    public function up()
    {
        ...
        foreach ($groups->each() as $group) {
            if ($group['can_create_public_spaces'] != 1) {
                $this->insertSilent('group_permission', [
                    ...
                    'group_id' => $group['id'],
                    'module_id' => 'space',
                    'class' => 'an602\modules\space\permissions\CreatePublicSpace',
                    'state' => '0'
                ]);
            }
            if ($group['can_create_private_spaces'] != 1) {
                $this->insertSilent('group_permission', [
                    ...
                    'group_id' => $group['id'],
                    'module_id' => 'space',
                    'class' => 'an602\modules\space\permissions\CreatePrivateSpace',
                    'state' => '0'
                ]);
            }
        }     
