...
use an602\modules\admin\Module as AdminModule;
...
use an602\modules\user\authclient\Password as PasswordAuth;
use an602\modules\user\behaviors\Followable;
use an602\modules\user\behaviors\ProfileController;
...
use an602\modules\user\widgets\UserWall;
use Yii;
...
class User extends ContentContainerActiveRecord implements IdentityInterface, Searchable
{
    ...
    {
        /** @var \an602\modules\content\Module $module */
