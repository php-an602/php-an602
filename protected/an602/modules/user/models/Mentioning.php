...
class Mentioning extends ActiveRecord
{
    ...
    public function behaviors()
    {
        return [
            [
                'class' => \an602\components\behaviors\PolymorphicRelation::class,
     ...
     * @throws Exception
     * @deprecated since 1.3 use [[\an602\modules\content\widgets\richtext\RichText::processText()]] instead
     */
    ...
    {
        return $this->hasOne(\an602\modules\user\models\User::class, ['id' => 'user_id']);
    }
