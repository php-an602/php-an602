...
/* @var $model \an602\modules\space\models\forms\InviteForm */
...
<div class="modal-footer">
    ...
    <?= Button::primary(Yii::t('SpaceModule.base',
        ...
        ->link('mailto:' .
            ...
            '&body=' . rawurlencode($this->renderFile($this->findViewFile('@an602/modules/user/views/mails/plaintext/UserInviteSpace'), [
...
<script <?= Html::nonce() ?>>
    $('#inviteform-allregisteredusers').on('change', function () {
        var userPicker = an602.modules.action.Component.instance('#space-invite-user-picker');
    ...
    $(function () {
        $('textarea[name="secureLink"]').click(function () {
            ...
            an602.modules.ui.status.success(successMsg);
        });
    });
</script>
