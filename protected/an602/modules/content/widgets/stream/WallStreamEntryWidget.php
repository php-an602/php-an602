...
namespace an602\modules\content\widgets\stream;

use Exception;
use an602\libs\Html;
use an602\modules\content\components\ContentActiveRecord;
use an602\modules\content\models\Content;
use an602\modules\content\widgets\ArchiveLink;
use an602\modules\content\widgets\DeleteLink;
use an602\modules\content\widgets\LockCommentsLink;
use an602\modules\content\widgets\EditLink;
use an602\modules\content\widgets\MoveContentLink;
use an602\modules\content\widgets\NotificationSwitchLink;
use an602\modules\content\widgets\PermaLink;
use an602\modules\content\widgets\PinLink;
use an602\modules\content\widgets\PublishDraftLink;
use an602\modules\content\widgets\ScheduleLink;
use an602\modules\content\widgets\VisibilityLink;
use an602\modules\dashboard\controllers\DashboardController;
 ...
 * }
 * ```
 * @package an602\modules\content\widgets\stream
 * @since 1.7
...
abstract class WallStreamEntryWidget extends StreamEntryWidget
{
     ...
     *             The class must be based on an602\modules\content\widgets\WallCreateContentForm
     */
