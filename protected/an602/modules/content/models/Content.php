...
use an602\components\behaviors\PolymorphicRelation;
...
use an602\modules\content\events\ContentEvent;
use an602\modules\content\events\ContentStateEvent;
use an602\modules\content\interfaces\ContentOwner;
use an602\modules\content\interfaces\SoftDeletable;
use an602\modules\content\live\NewContent;
use an602\modules\content\permissions\CreatePrivateContent;
...
class Content extends ActiveRecord implements Movable, ContentOwner, SoftDeletable
{
    ...
    private function notifyContentCreated()
    {
        ...
        \an602\modules\content\activities\ContentCreated::instance()
            ->from($this->createdBy)
    ...
    /**
     * @returns \an602\modules\content\models\Content content instance of this content owner
     */
