...
class ContentContainerModuleManager extends \yii\base\Component
{
    ...
    /**
     * Returns a query for \an602\modules\content\models\ContentContainer where the given module is enabled.
     *
    ...
    public static function getContentContainerQueryByModule($id)
    {
        ...
        $contentContainerClasses = [\an602\modules\user\models\User::class, \an602\modules\space\models\Space::class];
