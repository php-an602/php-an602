...
use an602\libs\ProfileImage;
use an602\modules\content\models\Content;
use an602\modules\content\models\ContentContainer;
use an602\modules\content\models\ContentContainerBlockedUsers;
...
abstract class ContentContainerActiveRecord extends ActiveRecord
{
     ...
     *
     * @since 1.3
     * @see \an602\modules\content\components\ContentContainerController
