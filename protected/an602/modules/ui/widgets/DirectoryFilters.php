...
abstract class DirectoryFilters extends Widget
{
    ...
    public function run()
    {
        return $this->render('@an602/modules/ui/widgets/views/directoryFilters', ['directoryFilters' => $this]);
    }
    ...
    public function renderFilters(): string
    {
        ...
        foreach ($this->filters as $filter => $data) {
            $filtersHtml .= $this->render('@an602/modules/ui/widgets/views/directoryFilter', [
