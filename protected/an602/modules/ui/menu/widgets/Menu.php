...
abstract class Menu extends JsWidget
{
    ...
    public function run()
    {
        ...
        if ($this->template === '@an602/widgets/views/leftNavigation') {
    ...
    public static function setViewState()
    {
        ...
        if (!empty($instance->id)) {
            ...
            $instance->view->registerJs('an602.modules.ui.navigation.setActive("' . $instance->id . '", ' . json_encode($active) . ');', View::POS_END, 'active-' . $instance->id);
        }
    }
