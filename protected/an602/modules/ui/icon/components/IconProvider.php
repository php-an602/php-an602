<?php
namespace an602\modules\ui\icon\components;
 ...
 *
 * The [[render()]] function of a IconProvider should ideally support all features of the [[\an602\modules\ui\icon\widgets\Icon]]
 * widget and furthermore map all icon names available in [[\an602\modules\ui\icon\widgets\Icon::$names]].
 *
 * @since 1.4
 */
