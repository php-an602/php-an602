...
class m150703_033650_namespace extends Migration
{
    ...
    public function up()
    {
        ...
        $this->update('notification', ['class' => 'an602\modules\comment\notifications\NewComment'], ['class' => 'NewCommentNotification']);
        $this->update('notification', ['class' => 'an602\modules\like\notifications\NewLike'], ['class' => 'NewLikeNotification']);
        $this->update('notification', ['class' => 'an602\modules\user\notifications\Followed'], ['class' => 'FollowNotification']);
        $this->update('notification', ['class' => 'an602\modules\user\notifications\Mentioned'], ['class' => 'MentionedNotification']);
        $this->update('notification', ['class' => 'an602\modules\content\notifications\ContentCreated'], ['class' => 'ContentCreatedNotification']);
        
        // Fixes
        $this->update('notification', ['source_class' => new Expression("NULL"), 'source_pk' => new Expression("NULL")], ['class'=>"an602\modules\user\notifications\Followed"]);
