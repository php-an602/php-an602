...
' => '--- モジュールを有効にしました: {moduleId} ---',
  ...
  'A new update is available (An602 %version%)!' => '新しいアップデートが利用可能です (An602 %version%)',
  'Add Licence Key' => 'ライセンスキーを追加',
  'Add purchased module by licence key' => 'ライセンスキーを使ってモジュールを購入する',
  'All' => 'すべて',
  'All {moduleId} module content will be deleted. Continue?' => '全ての {moduleId} モジュール コンテンツが削除されます。続けますか？',
...
' => 'An602 API に接続できませんでした',
  ...
  'Featured' => '特徴',
  'If this Module is additionally marked as <strong>"Community"</strong> it is neither tested nor monitored by the An602 project team.' => 'このモジュールが更に <strong>"Community%"</strong> としてマークされている場合、An602 プロジェクト チームによってテストも監視もされていません。',
  'Install' => 'インストール',
  'Installed' => 'インストール済',
...
' => 'モジュールが見つかりません',
  ...
  'Tags' => 'タグ',
  'The An602 project does not guarantee the functionality, quality or the continuous development of this Module.' => 'An602 プロジェクトは、このモジュールの機能、品質、または継続的な開発を保証しません。',
  ...
  'Version:' => 'バージョン：',
  'Your An602 installation is up to date!' => 'An602 のインストールは最新です。',
);
