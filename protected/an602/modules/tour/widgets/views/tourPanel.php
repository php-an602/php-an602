...
<div class="panel panel-default panel-tour" id="getting-started-panel">
    ...
    $removeOptionHtml = "<li>" . \an602\widgets\ModalConfirm::widget([
    ...
    <?php echo \an602\widgets\PanelMenu::widget(['id' => 'getting-started-panel', 'extraMenus' => $removeOptionHtml]); ?>
...
<?php if ($showWelcome): ?>
    <script <?= Html::nonce() ?>>
        $(document).on('an602:ready', function () {
            an602.modules.ui.modal.global.load( "<?= Url::to(['/tour/tour/welcome']) ?>");
        });
    </script>
<?php endif; ?>
