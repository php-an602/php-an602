...
namespace an602\modules\tour\widgets;

use an602\modules\tour\assets\TourAsset;
use Yii;

/**
 * Will show the introduction tour
 *
 * @package an602.modules_core.tour.widgets
 * @since 0.5
 * @author andystrobel
 */
class Tour extends \an602\components\Widget
{
    /**
