...
return array (
  ...
  'You are currently in the tools menu. From here you can access the an602 online marketplace, where you can install an ever increasing number of tools on-the-fly.<br><br>As already mentioned, the tools increase the features available for your space.' => 'ขณะนี้คุณอยู่ในเมนูเครื่องมือ จากที่นี่ คุณสามารถเข้าถึงตลาดออนไลน์ของ an602 ซึ่งคุณสามารถติดตั้งเครื่องมือจำนวนมากขึ้นเรื่อยๆ ได้ทันที<br><br>ดังที่ได้กล่าวไปแล้ว เครื่องมือต่างๆ จะช่วยเพิ่มคุณลักษณะที่มีให้สำหรับพื้นที่ของคุณ',
  'You have now learned about all the most important features and settings and are all set to start using the platform.<br><br>We hope you and all future users will enjoy using this site. We are looking forward to any suggestions or support you wish to offer for our project. Feel free to contact us via www.an602.org.<br><br>Stay tuned. :-)' => 'ตอนนี้คุณได้เรียนรู้เกี่ยวกับคุณลักษณะและการตั้งค่าที่สำคัญที่สุดทั้งหมดแล้ว และพร้อมที่จะเริ่มใช้แพลตฟอร์มนี้แล้ว<br><br>เราหวังว่าคุณจะและผู้ใช้ในอนาคตทุกคนจะสนุกกับการใช้ไซต์นี้ เรากำลังรอคอยข้อเสนอแนะหรือการสนับสนุนใด ๆ ที่คุณต้องการนำเสนอสำหรับโครงการของเรา อย่าลังเลที่จะติดต่อเราผ่านทาง www.an602.org<br><br>คอยติดตาม :-)',
);
