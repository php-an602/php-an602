...
return [
    ...
    '<strong>Welcome</strong> to an602<br>Your Social Network Toolbox' => '<strong>Benvenuto</strong> su an602<br> Il tuo  Social Network Toolbox',
    ...
    'Here you can decide how new, unregistered users can access an602.' => 'Qui puoi decidere come i nuovi utenti non registrati possono accedere a an602.',
    'Hostname' => 'Hostname',
    ...
    'The name of the database you want to run an602 in.' => 'Il nome della database in cui vuoi installare an602.',
    'This overview shows all system requirements of an602.' => 'Riepilogo di tutti i requisiti di sistema per an602.',
    'This wizard will install and configure your own an602 instance.<br><br>To continue, click Next.' => 'Questa procedura guidata installa e configura la tua istanza an602. <br><br> Per continuare, clicca su Avanti.',
    'To avoid a blank dashboard after your initial login, an602 can install example contents for you. Those will give you a nice general view of how an602 works. You can always delete the individual contents.' => 'Per non avere una dashboard vuota al primo login, an602 può installare dei contenuti di esempio per te. Questi ti danno una buona idea generale di come funziona an602. Puoi sempre eliminare i contenuti singolarmente.',
    ...
    'Yay! I\'ve just installed an602 :sunglasses:' => 'an602 è installato ed operativo! :sunglasses:',
