...
return [
    ...
    '<strong>Welcome</strong> to PHP-AN602<br>Your <strong>C</strong>oders<strong>E</strong>xchange Network ToolBox' => '<strong>Benvenuto</strong> su An602<br> Il tuo  Social Network Toolbox',
    ...
    'Here you can decide how new, unregistered users can access An602.' => 'Qui puoi decidere come i nuovi utenti non registrati possono accedere a Humhub.',
    'Hostname' => 'Hostname',
    ...
    'I want to use An602 for:' => 'Intendo usare Humhub per:',
    ...
    'This wizard will install and configure your personal PHP-AN602 <strong>C</strong>oders<strong>E</strong>xchange node.<br><br>To continue, click Next.' => 'Questa procedura guidata installa e configura la tua istanza Humhub. <br><br> Per continuare, clicca su Avanti.',
    ...
    'Yay! I\'ve just installed An602 :sunglasses:' => 'Humhub è installato ed operativo! :sunglasses:',
