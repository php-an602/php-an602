...
return [
    ...
    '<strong>Welcome</strong> to PHP-AN602<br>Your <strong>C</strong>oders<strong>E</strong>xchange Network ToolBox' => 'به هام هاب <strong>خوش‌آمدید</strong> <br> ابزارهای شبکه‌ی اجتماعی شما',
    ...
    'Here you can decide how new, unregistered users can access An602.' => 'اينجا مي توانيد تايين كنيد اعضاي جديد مهيا چگونه مي توانند به آن دسترسي داشته باشند',
    'Hostname' => 'نام میزبان',
    ...
    'I want to use An602 for:' => 'چرا مي خواهم از مهيا استفاده كنم؟',
...
<strong>ماژول هاي پيشنهادي</strong>',
    ...
    'The name of the database you want to run An602 in.' => 'نام پایگاه‌داده‌ای که می‌خواهید هام‌هاب را در آن اجرا کنید.',
    'This overview shows all system requirements of An602.' => 'این بررسی اجمالی نمایانگر تمامی نیازهای سیستم هام‌هاب است.',
    'This wizard will install and configure your personal PHP-AN602 <strong>C</strong>oders<strong>E</strong>xchange node.<br><br>To continue, click Next.' => 'این پنجره نمونه‌ی هام‌هاب شما را نصب و تنطیم خواهد‌کرد',
    'To avoid a blank dashboard after your initial login, An602 can install example contents for you. Those will give you a nice general view of how An602 works. You can always delete the individual contents.' => 'براي اينكه مهيا خالي نباشد، لطفا مطالب پيشفرض را وارد كنيد',
    ...
    'Yay! I\'ve just installed An602 :sunglasses:' => 'بالاخره مهيا نصب شد! هورا',
