...
return array (
  ...
  '<strong>Welcome</strong> to PHP-AN602<br>Your <strong>C</strong>oders<strong>E</strong>xchange Network ToolBox' => '<strong>Bienvenue</strong> sur An602<br>Votre réseau social',
  ...
  'Here you can decide how new, unregistered users can access An602.' => 'Vous pouvez décider ici de la façon dont les nouveaux utilisateurs non inscrits peuvent accéder à An602.',
  'Hostname' => 'Nom d\'hôte',
  ...
  'On An602\'s side, you will need to edit the configuration file <code>{configFile}</code> and add the following block:' => 'Du côté de An602, vous devrez modifier le fichier de configuration <code>{configFile}</code> en y ajoutant le bloc suivant :',
  'Open the crontab of An602/PHP process user e.g. <code>{user}</code>.' => 'Ouvrez le crontab de l’utilisateur du processus An602/PHP, par exemple <code>{user}</code>.',
  ...
  'The name of the database you want to run An602 in.' => 'Le nom de la base de données dans laquelle An602 va fonctionner.',
  'This overview shows all system requirements of An602.' => 'Cet aperçu affiche tous les prérequis système de An602.',
  ...
  'This wizard will install and configure your personal PHP-AN602 <strong>C</strong>oders<strong>E</strong>xchange node.<br><br>To continue, click Next.' => 'Cet assistant va installer et configurer votre propre instance de An602.<br><br>Pour continuer, cliquez sur Suivant.',
  'To avoid a blank dashboard after your initial login, An602 can install example contents for you. Those will give you a nice general view of how An602 works. You can always delete the individual contents.' => 'Pour éviter d\'avoir un fil d\'actualité vide après votre première connexion, An602 peut créer pour vous quelques exemples de contenu. Ceux-ci vous donneront un aperçu sympathique du fonctionnement de An602. Vous pouvez à tout moment supprimer chacun des contenus.',
  ...
  'Yay! I\'ve just installed An602 :sunglasses:' => 'Yay ! Je viens d\'installer An602 :sunglasses:',
