...
return [
    ...
    '<strong>Welcome</strong> to an602<br>Your Social Network Toolbox' => '<strong>Välkommen</strong> till an602<br>din verktygslåda för sociala forum',
    ...
    'This wizard will install and configure your own an602 instance.<br><br>To continue, click Next.' => 'Den här guiden kommer att installera och konfigurera din egen an602-instans.<br><br>Klicka på Nästa för att fortsätta.',
