...
return [
    ...
    '<strong>Welcome</strong> to PHP-AN602<br>Your <strong>C</strong>oders<strong>E</strong>xchange Network ToolBox' => '<strong>Välkommen</strong> till An602<br>din verktygslåda för sociala forum',
    ...
    'Here you can decide how new, unregistered users can access An602.' => 'Här kan du bestämma hur nya, ej registrerade användare kan komma åt An602.',
    'Hostname' => 'Host namn',
    ...
    'The name of the database you want to run An602 in.' => 'Namnet på databasen du vill köra An602 i.',
    'This overview shows all system requirements of An602.' => 'Den här översikten visar alla systemkrav för An602.',
    'This wizard will install and configure your personal PHP-AN602 <strong>C</strong>oders<strong>E</strong>xchange node.<br><br>To continue, click Next.' => 'Den här guiden kommer att installera och konfigurera din egen An602-instans.<br><br>Klicka på Nästa för att fortsätta.',
    'To avoid a blank dashboard after your initial login, An602 can install example contents for you. Those will give you a nice general view of how An602 works. You can always delete the individual contents.' => 'För att undvika en tom Dashboard efter din första inloggning kan An602 installera exempelinnehåll åt dig. De ger dig en bra allmän bild av hur An602 fungerar. Du kan alltid ta bort det enskilda innehållet.',
    ...
    'Yay! I\'ve just installed An602 :sunglasses:' => 'Jippie! Jag har precis installerat An602 : sunglasses:',
