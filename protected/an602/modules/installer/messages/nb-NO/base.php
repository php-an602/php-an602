...
return [
    ...
    '<strong>Welcome</strong> to PHP-AN602<br>Your <strong>C</strong>oders<strong>E</strong>xchange Network ToolBox' => '<strong>Velkommen</strong> til An602<br>Ditt sosiale nettverk!',
    ...
    'Here you can decide how new, unregistered users can access An602.' => 'Her kan du bestemme hvordan nye, uregistrerte brukere kan få tilgang til An602.',
    'Hostname' => 'Host',
    ...
    'The name of the database you want to run An602 in.' => 'Navnet på databasen',
    'This overview shows all system requirements of An602.' => 'Denne oversikten viser deg systemkravene for An602.',
    'This wizard will install and configure your personal PHP-AN602 <strong>C</strong>oders<strong>E</strong>xchange node.<br><br>To continue, click Next.' => 'Denne veiviseren vil installere og tilpasse din An602 installasjon.<br><br>Trykk neste for å fortsette.',
    'To avoid a blank dashboard after your initial login, An602 can install example contents for you. Those will give you a nice general view of how An602 works. You can always delete the individual contents.' => 'For å unngå et tomt dashboard når du logger inn første gangen, kan An602 installere eksempeldata for deg. Dette gir deg et godt førsteinntrykk av hvordan An602 fungerer. Du kan enkelt slette innholdet.',
    ...
    'Yay! I\'ve just installed An602 :sunglasses:' => 'Yay! I\'ve just installed An602 :sunglasses:',
