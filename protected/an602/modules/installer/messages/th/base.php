...
return [
    ...
    '<strong>Welcome</strong> to PHP-AN602<br>Your <strong>C</strong>oders<strong>E</strong>xchange Network ToolBox' => '<strong>ยินดีต้อนรับ</strong> สู่ An602<br>กล่องเครื่องมือเครือข่ายสังคมของคุณ',
    ...
    'Here you can decide how new, unregistered users can access An602.' => 'ที่นี่คุณสามารถตัดสินใจได้ว่าผู้ใช้ใหม่ที่ไม่ได้ลงทะเบียนสามารถเข้าถึง An602 ได้อย่างไร',
    'Hostname' => 'ชื่อโฮสต์',
    ...
    'The name of the database you want to run An602 in.' => 'ชื่อของฐานข้อมูลที่คุณต้องการเรียกใช้ An602',
    'This overview shows all system requirements of An602.' => 'ภาพรวมนี้แสดงความต้องการของระบบทั้งหมดของ HumHu',
    'This wizard will install and configure your personal PHP-AN602 <strong>C</strong>oders<strong>E</strong>xchange node.<br><br>To continue, click Next.' => 'วิซาร์ดนี้จะติดตั้งและกำหนดค่าอินสแตนซ์ An602 ของคุณเอง<br><br>หากต้องการดำเนินการต่อ ให้คลิกถัดไป',
    'To avoid a blank dashboard after your initial login, An602 can install example contents for you. Those will give you a nice general view of how An602 works. You can always delete the individual contents.' => 'เพื่อหลีกเลี่ยงหน้าแดชบอร์ดที่ว่างเปล่าหลังจากการเข้าสู่ระบบครั้งแรกของคุณ An602 สามารถติดตั้งเนื้อหาตัวอย่างให้คุณได้ สิ่งเหล่านี้จะให้มุมมองทั่วไปที่ดีเกี่ยวกับวิธีการทำงานของ An602 คุณสามารถลบเนื้อหาแต่ละรายการได้ตลอดเวลา',
    ...
    'Yay! I\'ve just installed An602 :sunglasses:' => 'เย้! ฉันเพิ่งติดตั้ง An602 :sunglasses:',
