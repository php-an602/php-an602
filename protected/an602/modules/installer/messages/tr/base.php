...
return [
    ...
    '<strong>Welcome</strong> to PHP-AN602<br>Your <strong>C</strong>oders<strong>E</strong>xchange Network ToolBox' => '<strong>Humhub</strong>\'a hoşgeldiniz<br />Sosyal Ağınız',
    ...
    'Here you can decide how new, unregistered users can access An602.' => 'Burada kayıtlı olmayan yeni kullanıcıların An602\'a nasıl erişebileceğine karar verebilirsiniz.',
    ...
    'The name of the database you want to run An602 in.' => 'Humhub kurulumu için çalışmak istediğiniz veritabanı adı.',
    'This overview shows all system requirements of An602.' => 'An602 sistem gereksinimlerinizin uygun olup olmadığını gösterir.',
    'This wizard will install and configure your personal PHP-AN602 <strong>C</strong>oders<strong>E</strong>xchange node.<br><br>To continue, click Next.' => 'Kurulum sihirbazı ile kendi Humhub Sosyal Ağınızı oluşturabilirsiniz.<br />Devam etmek için İleri\'ye tıklayın.',
    'To avoid a blank dashboard after your initial login, An602 can install example contents for you. Those will give you a nice general view of how An602 works. You can always delete the individual contents.' => 'İlk girişinizden sonra An602 sizin için örnek içerik panosunu yükler. Bu, An602\'un nasıl çalıştığına dair genel bir bakış açısı verecektir. Bireysel içeriği her zaman silebilirsiniz.',
    ...
    'Yay! I\'ve just installed An602 :sunglasses:' => 'Yuppi! Az önce An602\'ı kurdum :sunglasses:',
