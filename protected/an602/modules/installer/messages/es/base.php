...
return array (
  ...
  '<strong>Welcome</strong> to PHP-AN602<br>Your <strong>C</strong>oders<strong>E</strong>xchange Network ToolBox' => '<strong>Bienvenido</strong> a An602<br />',
  ...
  'Here you can decide how new, unregistered users can access An602.' => 'Aquí puedes decidir cómo los nuevos usuarios, no registrados, pueden acceder a An602',
  ...
  'On An602\'s side, you will need to edit the configuration file <code>{configFile}</code> and add the following block:' => 'Respecto a An602, tienes que editar el fichero de configuración <code>{configFile}</code> y añadir el siguiente bloque de código:',
  'Open the crontab of An602/PHP process user e.g. <code>{user}</code>.' => 'Abrir el usuario del proceso An602/PHP, por ejemplo: <code>{user}</code>.',
  ...
  'The name of the database you want to run An602 in.' => 'El nombre de la base de datos donde quieres que funcione An602.',
  'This overview shows all system requirements of An602.' => 'Este resumen te mostrará todos los requisitos del sistema para que funcione An602.',
  ...
  'This wizard will install and configure your personal PHP-AN602 <strong>C</strong>oders<strong>E</strong>xchange node.<br><br>To continue, click Next.' => 'Este asistente instalará y configurará An602.<br /><br />Para continuar, haz click en Siguiente.',
  'To avoid a blank dashboard after your initial login, An602 can install example contents for you. Those will give you a nice general view of how An602 works. You can always delete the individual contents.' => 'Para evitar tener un tablero de control vacío cuando entres en el sistema, An602 puede instalar contenidos de ejemplo. Te proporcionan una visión general de cómo funciona An602. Luego puedes borrar contenidos individuales.',
  ...
  'Yay! I\'ve just installed An602 :sunglasses:' => '¡Yuju! Acabo de instalar An602; ¡Mola!',
