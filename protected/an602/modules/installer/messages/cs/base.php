...
return [
    ...
    '<strong>Welcome</strong> to PHP-AN602<br>Your <strong>C</strong>oders<strong>E</strong>xchange Network ToolBox' => '<strong>Vítejte</strong> v síti An602',
    ...
    'Here you can decide how new, unregistered users can access An602.' => 'Zde se můžete rozhodnout, co všechno mohou dělat neregistrovaní uživatelé.',
    'Hostname' => 'Hostname',
    ...
    'The name of the database you want to run An602 in.' => 'Jméno databáze, do které chcete An602 nainstalovat.',
    'This overview shows all system requirements of An602.' => 'Tento přehled ukazuje všechny požadavky An602u.',
    'This wizard will install and configure your personal PHP-AN602 <strong>C</strong>oders<strong>E</strong>xchange node.<br><br>To continue, click Next.' => 'Tento průvodce vám pomůže nainstalovat a nastavit síť An602.<br><br>Chcete-li pokračovat, klikněte na tlačítko Další.',
    ...
    'Yay! I\'ve just installed An602 :sunglasses:' => 'Jupí, právě jsme nainstalovali An602 :sunglasses:',
