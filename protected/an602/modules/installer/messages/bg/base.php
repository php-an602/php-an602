...
return [
    ...
    '<strong>Welcome</strong> to an602<br>Your Social Network Toolbox' => '<strong>Добре дошли</strong> в an602 <br>Кутията с инструменти за Вашата Социална Мрежа',
    ...
    'This wizard will install and configure your own an602 instance.<br><br>To continue, click Next.' => 'Този съветник ще инсталира и конфигурира вашата собствена инстанция на an602.<br><br>За да продължите, щракнете върху Напред.',
