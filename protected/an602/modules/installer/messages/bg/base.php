...
return [
    ...
    '<strong>Welcome</strong> to PHP-AN602<br>Your <strong>C</strong>oders<strong>E</strong>xchange Network ToolBox' => '<strong>Добре дошли</strong> в An602 <br>Кутията с инструменти за Вашата Социална Мрежа',
    ...
    'Here you can decide how new, unregistered users can access An602.' => 'Тук можете да решите как нови, нерегистрирани потребители могат да имат достъп до An602.',
    ...
    'The name of the database you want to run An602 in.' => 'Името на базата от данни, в която искате да стартирате An602.',
    'This overview shows all system requirements of An602.' => 'Този общ преглед показва всички системни изисквания на An602.',
    'This wizard will install and configure your personal PHP-AN602 <strong>C</strong>oders<strong>E</strong>xchange node.<br><br>To continue, click Next.' => 'Този съветник ще инсталира и конфигурира вашата собствена инстанция на An602.<br><br>За да продължите, щракнете върху Напред.',
    'To avoid a blank dashboard after your initial login, An602 can install example contents for you. Those will give you a nice general view of how An602 works. You can always delete the individual contents.' => 'За да избегнете празно табло след първоначалното ви влизане, An602 може да инсталира примерно съдържание за вас. Това ще ви даде хубава обща представа за това как работи An602. Винаги можете да изтриете генерираното съдържание.',
    ...
    'Yay! I\'ve just installed An602 :sunglasses:' => 'Еха! Току-що инсталирах An602; Страхотно;',
