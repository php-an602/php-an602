...
return [
    ...
    '<strong>Welcome</strong> to PHP-AN602<br>Your <strong>C</strong>oders<strong>E</strong>xchange Network ToolBox' => '<strong>欢迎来到</strong> An602<br>你的社交网络工具箱！',
    ...
    'Here you can decide how new, unregistered users can access An602.' => '在这里你可以决是否允许定新的，未注册的用户访问An602。',
    'Hostname' => '主机名',
    ...
    'The name of the database you want to run An602 in.' => '你想要存an602数据的数据库名',
    'This overview shows all system requirements of An602.' => '以下展示了an602的所有系统需求',
    'This wizard will install and configure your personal PHP-AN602 <strong>C</strong>oders<strong>E</strong>xchange node.<br><br>To continue, click Next.' => '该向导将安装和配置你自己的an602实例.<br><br>点击下一步继续。',
    'To avoid a blank dashboard after your initial login, An602 can install example contents for you. Those will give you a nice general view of how An602 works. You can always delete the individual contents.' => '为了避免初始登录后空白的仪表板，an602可以安装一些示例内容。这将给你一个很好an602概览。您可以随时删除示例内容。',
    ...
    'Welcome Space' => '欢迎空间',
    'Yay! I\'ve just installed An602 :sunglasses:' => '太棒了，我刚刚安装了An602',
