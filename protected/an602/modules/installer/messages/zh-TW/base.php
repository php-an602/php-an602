...
return array (
  ...
  '<strong>Welcome</strong> to PHP-AN602<br>Your <strong>C</strong>oders<strong>E</strong>xchange Network ToolBox' => '<strong>歡迎</strong>來到An602<br>您的社群網路工具箱',
  ...
  'An602 uses cron jobs to execute scheduled or to run potentially heavy tasks such as sending out email summaries and notifications or optimizing the search index.' => 'An602使用cron job任務排程器，用來執行定期排程的任務，或者執行可能耗用較多資源的工作，例如寄送E-mail彙總、通知、或者優化搜尋資料庫的索引。',
  'I want to use An602 for:' => '我想將An602用於:',
  ...
  'The name of the database you want to run An602 in.' => '您打算用來安裝An602的資料庫名稱。',
  'This overview shows all system requirements of An602.' => '',
  ...
  'This wizard will install and configure your personal PHP-AN602 <strong>C</strong>oders<strong>E</strong>xchange node.<br><br>To continue, click Next.' => '這個安裝精靈將會帶領您安裝和設定您自己的Humhub網站<br><br>要繼續操作，請點選下一步。',
  ...
  'Welcome Space' => '',
  'Yay! I\'ve just installed An602 :sunglasses:' => '耶! 我已經安裝好了新的 An602 :sunglasses:',
