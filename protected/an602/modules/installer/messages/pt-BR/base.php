...
return [
    ...
    '<strong>Welcome</strong> to PHP-AN602<br>Your <strong>C</strong>oders<strong>E</strong>xchange Network ToolBox' => '<strong>Bem-vindo</strong> ao An602<br> Sua ferramenta de Rede Social',
    ...
    'Here you can decide how new, unregistered users can access An602.' => 'Aqui você pode decidir como novos usuários não registrados podem acessar o An602.',
    ...
    'The name of the database you want to run An602 in.' => 'O nome do banco de dados configurado para a instalação do An602.',
    'This overview shows all system requirements of An602.' => 'Esta visão geral mostra todos os requisitos de sistema do An602.',
    'This wizard will install and configure your personal PHP-AN602 <strong>C</strong>oders<strong>E</strong>xchange node.<br><br>To continue, click Next.' => 'Este assistente irá instalar e configurar sua própria instância do An602. <br /> Para continuar, clique em Avançar.',
    'To avoid a blank dashboard after your initial login, An602 can install example contents for you. Those will give you a nice general view of how An602 works. You can always delete the individual contents.' => 'Para evitar um painel em branco após o login inicial, o An602 pode instalar conteúdos de exemplo para você. Eles te darão uma boa visão de como An602 trabalha. Você sempre pode excluir cada conteúdo individualmente.',
    ...
    'Yay! I\'ve just installed An602 :sunglasses:' => 'Yay! Acabei de instalar o An602 :sunglasses:',
