...
return [
    ...
    '<strong>Welcome</strong> to PHP-AN602<br>Your <strong>C</strong>oders<strong>E</strong>xchange Network ToolBox' => '<strong>Witaj</strong> w An602<br>Szwajcarskim scyzoryku Twojej Sieci Społecznościowej',
    ...
    'Here you can decide how new, unregistered users can access An602.' => 'Zadecyduj jak nowi, niezarejestrowani użytkownicy mogą korzystać z An602.',
    ...
    'The name of the database you want to run An602 in.' => 'Nazwa bazy danych dla An602',
    'This overview shows all system requirements of An602.' => 'To podsumowanie prezentuje wszystkie wymagania systemowe An602.',
    'This wizard will install and configure your personal PHP-AN602 <strong>C</strong>oders<strong>E</strong>xchange node.<br><br>To continue, click Next.' => 'Ten kreator pomoże Ci skonfigurować własną instalację An602.<br><br> Aby kontynuować naciśnij "Dalej".',
    'To avoid a blank dashboard after your initial login, An602 can install example contents for you. Those will give you a nice general view of how An602 works. You can always delete the individual contents.' => 'Aby uniknąć pustego kokpitu zaraz po pierwszym zalogowaniu, An602 może zainstalować przykładowe treści. Przybliży Ci to ogólną zasadę działania An602. W każdym momencie możesz usunąć poszczególne treści.',
    ...
    'Yay! I\'ve just installed An602 :sunglasses:' => 'Hurra! Właśnie zainstalowałem An602 :sunglasses:',
