...
Deinem Sozialen Netzwerk.',
  ...
  'Here you can decide how new, unregistered users can access an602.' => 'Hier kannst du entscheiden, wie neue, nicht registrierte Benutzer auf an602 zugreifen können.',
  'Hostname' => 'Hostname',
  ...
  'an602 is very flexible and can be adjusted and/or expanded for various different applications thanks to its’ different modules.  The following modules are just a few examples and the ones we thought are most important for your chosen application.<br><br>You can always install or remove modules later. You can find more available modules after installation in the admin area.' => 'an602 ist sehr flexibel und kann dank seiner verschiedenen Module für verschiedene Anwendungen angepasst und/oder erweitert werden. Die folgenden Module sind nur einige Beispiele und die, die wir für die von dir gewählte Verwendung für sehr wichtig gehalten haben.<br /><br />Du kannst Module jederzeit später installieren oder entfernen. Weitere verfügbare Module findest du nach der Installation im Admin-Bereich.',
  'an602 uses cron jobs to execute scheduled or to run potentially heavy tasks such as sending out email summaries and notifications or optimizing the search index.' => 'an602 verwendet Cron Jobs, um geplante oder potenziell schwere Aufgaben auszuführen, wie das Versenden von E-Mail-Zusammenfassungen und -Benachrichtigungen oder die Optimierung des Suchindexes.',
  'I want to use an602 for:' => 'Ich möchte an602 benutzen für:',
  'In order to activate this feature, it is necessary to edit the an602 configuration and, potentially, the configuration of the WebServer.' => 'Um diese Funktion zu aktivieren, ist es notwendig, die an602-Konfiguration und gegebenenfalls die Konfiguration des WebServers zu bearbeiten.',
  ...
  'On an602\'s side, you will need to edit the configuration file <code>{configFile}</code> and add the following block:' => 'Auf der Seite von an602 muss die Konfigurationsdatei <code>{configFile}</code> bearbeitet und der folgende Block hinzufügt werden:',
  'Open the crontab of an602/PHP process user e.g. <code>{user}</code>.' => 'Öffne die Crontab des an602/PHP-Prozessbenutzers, z.B. <code>{user}</code>.',
  ...
  'Yay! I\'ve just installed an602 :sunglasses:' => 'Yay! Ich habe gerade an602 installiert :sunglasses:',
