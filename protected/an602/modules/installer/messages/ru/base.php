...
return [
    ...
    '<strong>Welcome</strong> to PHP-AN602<br>Your <strong>C</strong>oders<strong>E</strong>xchange Network ToolBox' => '<strong>Добро пожаловать</strong> в An602<br>Это Ваша социальная сеть',
    ...
    'The name of the database you want to run An602 in.' => 'Имя базы данных MySQL',
    'This overview shows all system requirements of An602.' => 'Список ниже содежит все системные требования и рекомендации для An602.',
    'This wizard will install and configure your personal PHP-AN602 <strong>C</strong>oders<strong>E</strong>xchange node.<br><br>To continue, click Next.' => 'Мастер установки настроит Ваш собственный экземпляр An602.<br><br>Чтобы продолжить, нажмите кнопку Далее.',
    'To avoid a blank dashboard after your initial login, An602 can install example contents for you. Those will give you a nice general view of how An602 works. You can always delete the individual contents.' => 'Чтобы избежать пустой главной страницы после завершения установки, An602 может установить некоторые демо данные для Вас. Это даст Вам хороший первоначальный общий вид и понимание того, как An602 работает. Вы всегда можете удалить демо содержимое в любой момент.',
    'To simplify the configuration, we have predefined setups for the most common use cases with different options for modules and settings. You can adjust them during the next step.' => 'Для упрощения процесса установки, у нас есть предопределенные настройки для наиболее распространенных случаев использования An602 с различными опциями для модулей и настроек. Вы можете настроить их на следующем этапе.',
    ...
    'Yay! I\'ve just installed An602 :sunglasses:' => 'Ура! Я только что установил An602 :sunglasses:',
    ...
    'In order to activate this feature, it is necessary to edit the An602 configuration and, potentially, the configuration of the WebServer.' => '',
