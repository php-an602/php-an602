...
return [
    ...
    '<strong>Welcome</strong> to an602<br>Your Social Network Toolbox' => '<strong>Добро пожаловать</strong> в an602<br>Это Ваша социальная сеть',
    ...
    'This wizard will install and configure your own an602 instance.<br><br>To continue, click Next.' => 'Мастер установки настроит Ваш собственный экземпляр an602.<br><br>Чтобы продолжить, нажмите кнопку Далее.',
