...
class InitialData
{
    ...
    public static function bootstrap()
    {
        ...
        Yii::$app->getModule('activity')->settings->set('mailSummaryInterval', \an602\modules\activity\components\MailSummary::INTERVAL_DAILY);
        ...
        $field->field_type_class = \an602\modules\user\models\fieldtype\Text::class;
        ...
        $field->sort_order = 300;
        $field->profile_field_category_id = $cGeneral->id;
        $field->field_type_class = \an602\modules\user\models\fieldtype\Select::class;
        $field->is_system = 1;
        if ($field->save()) {
        ...
        $field->profile_field_category_id = $cGeneral->id;
        $field->field_type_class = \an602\modules\user\models\fieldtype\CountrySelect::class;
        $field->is_system = 1;
        if ($field->save()) {
            $field->fieldType->save();
        }
        ...
        $field->profile_field_category_id = $cGeneral->id;
        $field->field_type_class = \an602\modules\user\models\fieldtype\Birthday::class;
        $field->is_system = 1;
        if ($field->save()) {
            $field->fieldType->save();
        }
        ...
        $field->sort_order = 900;
        $field->profile_field_category_id = $cGeneral->id;
        $field->field_type_class = \an602\modules\user\models\fieldtype\TextArea::class;
        $field->is_system = 1;
        if ($field->save()) {
            #$field->fieldType->maxLength = 100;
            $field->fieldType->save();
        ...
        $field->visible = 0;
        $field->profile_field_category_id = $cCommunication->id;
        $field->field_type_class = \an602\modules\user\models\fieldtype\UserEmail::class;
        if ($field->save()) {
            $field->fieldType->save();
        }
