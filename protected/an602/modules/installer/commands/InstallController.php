...
use an602\modules\installer\libs\InitialData;
use an602\libs\UUID;
...
class InstallController extends Controller
{
    ...
    public function actionInstallDb()
    {
        ...
        \an602\commands\MigrateController::webMigrateAll();
     ...
     */
    public function actionCreateAdminAccount($admin_user='admin', $admin_email='an602@example.com', $admin_pass='test')
    {
        $user = new User();
