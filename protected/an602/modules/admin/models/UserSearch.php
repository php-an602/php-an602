...
class UserSearch extends User
{
    ...
    /**
     * @var \an602\modules\user\components\ActiveQueryUser
     */
    public $query;
    ...
    public function search($params)
    {
        ...
        /* @var $query \an602\modules\user\components\ActiveQueryUser */
        ...
        if ($this->getAttribute('last_login') != "") {
            try {
                $last_login = \an602\libs\DateHelper::parseDateTime($this->getAttribute('last_login'));
