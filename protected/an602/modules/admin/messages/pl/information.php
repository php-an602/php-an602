...
return [
    ...
    'Base URL' => 'Główny URL',
    'Checking an602 software prerequisites.' => 'Sprawdzanie wstępnych wymagań oprogramowania an602.',
    ...
    'an602 is currently in debug mode. Disable it when running on production!' => 'an602 jest w trybie debugowania. Wyłącz go gdy udostępnisz stronę użytkownikom!',
    ...
    'The current main an602 database name is ' => 'Obecna nazwa głównej bazy danych an602 to:',
    'There is a new update available! (Latest version: %version%)' => 'Dostępna jest aktualizacja! (Najnowsza wersja: %version%)',
    'This an602 installation is up to date!' => 'Ta instalacja an602a jest aktualna!',
