...
return [
    ...
    'Base URL' => 'URL base',
    'Checking an602 software prerequisites.' => 'Verificando os pré-requisitos de software an602.',
    ...
    'The current main an602 database name is ' => 'O nome atual do banco de dados an602 é',
    'There is a new update available! (Latest version: %version%)' => 'Uma nova atualização está disponível! (Versão mais recente: %version%)',
    'This an602 installation is up to date!' => 'Esta instalação do HumHum está atualizada!',
