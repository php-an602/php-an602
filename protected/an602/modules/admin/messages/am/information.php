...
return [
    ...
    'Settings' => 'ማስተካከያዎች',
    'The current main an602 database name is ' => 'አሁን ያለው ዋነኛ የan602 ዳታቤዝ ስም',
    'There is a new update available! (Latest version: %version%)' => 'አዲስ የሚያዘምኑት ሞጁል አለ! (የምጨረሻ ጊዜ ምርት: %version%)',
    'This an602 installation is up to date!' => 'ይህ የተጫነው an602 የዘመነ ነው!',
    'Total {count} entries found.' => 'በጠቅላላው {count} ገብተው ተገኝተዋል።',
    'Waiting' => 'በጥበቃ ላይ...',
    'Assets' => '',
    'Checking an602 software prerequisites.' => '',
