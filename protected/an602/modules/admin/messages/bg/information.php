...
return [
    ...
    'About An602' => 'За An602',
    'Background Jobs' => 'Задачи в заден фон',
    'Base URL' => 'Базов URL',
    'Checking An602 software prerequisites.' => 'Проверка на необходимият софтуер за Humhub инсталация.',
    ...
    'Settings' => 'Настройки',
    'The current main An602 database name is ' => 'Текущото основно име на An602 база от данни е',
    'There is a new update available! (Latest version: %version%)' => 'Налична е нова актуализация! (Последна версия:%version%)',
    'This An602 installation is up to date!' => 'Тази инсталация на An602 е актуална!',
