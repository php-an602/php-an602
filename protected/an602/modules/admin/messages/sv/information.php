...
return [
    ...
    'About an602' => 'Om an602',
    'Assets' => 'Aktiva',
    'Background Jobs' => 'Jobb i bakgrunden',
    'Base URL' => 'Bas-URL',
    'Checking an602 software prerequisites.' => 'Kontrollerar förutsättningarna för programvaran an602',
    ...
    'The current main an602 database name is ' => 'Det nuvarande namnet på huvud an602-databasen är',
    'There is a new update available! (Latest version: %version%)' => 'Det finns en ny uppdatering tillgänglig! (Senaste version: %version%)',
    'This an602 installation is up to date!' => 'Denna an602-installation är uppdaterad!',
    'Time zone' => 'Tidszon',
