...
return array (
  ...
  'About an602' => 'Sobre an602',
  'Assets' => 'Activos',
  'Background Jobs' => 'Tareas en background',
  'Base URL' => 'URL base',
  'Checking an602 software prerequisites.' => 'Comprobando prerequisitos software de an602.',
  ...
  'an602' => 'an602',
  'an602 Documentation' => 'Documentación de an602',
  'an602 is currently in debug mode. Disable it when running on production!' => 'an602 está actualmente en modo de depuración. ¡Deshabilitarlo cuando se ejecute en la producción!',
  ...
  'The current main an602 database name is ' => 'El nombre de la base de datos principal de an602 es',
  'There is a new update available! (Latest version: %version%)' => '¡Hay una nueva versión disponible! (Última versión: %version%)',
  'This an602 installation is up to date!' => '¡Esta instalación de an602 ya está actualizada!',
