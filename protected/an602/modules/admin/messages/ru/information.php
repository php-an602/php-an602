...
return [
    ...
    'Checking an602 software prerequisites.' => 'Проверка необходимого програмного обеспечения для сайта.',
    ...
    'an602 is currently in debug mode. Disable it when running on production!' => 'an602 в данный момент находится в режиме отладки. Отключите его при работе на действующем проекте!',
    'Info' => 'Информация',
    ...
    'Settings' => 'Настройки',
    'The current main an602 database name is ' => 'Текущее имя основной базы данных an602: ',
    'There is a new update available! (Latest version: %version%)' => 'Доступно новое обновление!  (Последняя версия: %version%)',
    'This an602 installation is up to date!' => 'Ваша версия an602 актуальна (самая свежая)!',
