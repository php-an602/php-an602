...
class PermissionCest
{
    ...
    public function testCanManageUsers(FunctionalTester $I)
    {
        ...
        $I->setGroupPermission(3, new \an602\modules\admin\permissions\ManageUsers());
    ...
    public function testCanManageGroups(FunctionalTester $I)
    {
        ...
        $I->setGroupPermission(3, new \an602\modules\admin\permissions\ManageGroups());
    ...
    public function testCanManageSettings(FunctionalTester $I)
    {
        ...
        $I->setGroupPermission(3, new \an602\modules\admin\permissions\ManageSettings());
