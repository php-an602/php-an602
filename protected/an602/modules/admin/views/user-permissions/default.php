...
use an602\libs\Html;
use an602\modules\admin\assets\AdminAsset;
use an602\modules\user\widgets\PermisionGridModuleFilter;
use an602\modules\user\widgets\PermissionGridEditor;
use yii\helpers\Url;

/* @var $defaultPermissionManager \an602\modules\content\components\ContentContainerDefaultPermissionManager */
/* @var $groups array */
/* @var $groupId string */
...
/** @var \an602\modules\user\Module $userModule */
