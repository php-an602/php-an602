...
use an602\modules\admin\models\forms\BasicSettingsForm;
use an602\modules\admin\models\forms\CacheSettingsForm;
use an602\modules\admin\models\forms\DesignSettingsForm;
use an602\modules\admin\models\forms\FileSettingsForm;
use an602\modules\admin\models\forms\LogsSettingsForm;
use an602\modules\admin\models\forms\MailingSettingsForm;
use an602\modules\admin\models\forms\OEmbedProviderForm;
use an602\modules\admin\models\forms\OEmbedSettingsForm;
use an602\modules\admin\models\forms\ProxySettingsForm;
use an602\modules\admin\models\forms\StatisticSettingsForm;
...
class SettingController extends Controller
{
    ...
    public function actionMailingServerTest()
    {
        ...
        try {
            $mail = Yii::$app->mailer->compose(['html' => '@an602/views/mail/TextOnly'], [
