...
an602.module('stream.Stream', function (module, require, $) {
    ...
    var EVENT_AFTER_ADD_ENTRIES = 'an602:stream:afterAddEntries';
    var EVENT_BEFORE_ADD_ENTRIES = 'an602:stream:beforeAddEntries';
    var EVENT_INITIALIZED = 'an602:stream:initialized';
    ...
    Stream.prototype.initDefaultEvents = function () {
        var that = this;
        event.on('an602:modules:content:live:NewContent.stream', function (evt, events) {
            if (!events
    ...
    Stream.prototype.clear = function () {
        ...
        this.trigger('an602:stream:clear', this);
        this.onClear();
        return this;
    };
    ...
    Stream.prototype.handleLastEntryLoaded = function() {
        ...
        this.trigger('an602:stream:lastEntryLoaded', [this]);
     ...
     *
     * @returns {an602_stream_L5.Stream.$.find.length}
     */
