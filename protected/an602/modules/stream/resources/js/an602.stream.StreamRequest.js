...
an602.module('stream.StreamRequest', function (module, require, $) {
    ...
    StreamRequest.prototype.load = function() {
        this.stream.trigger('an602:stream:beforeLoadEntries', [this.stream, this]);
        ...
        return that._send().then(function (response) {
            ...
            that.stream.trigger('an602:stream:afterLoadEntries', [that.stream, this]);
            return that;
        }).finally(function () {
            that.stream.state.loading = false;
        });
