...
use DateTime;
use an602\libs\StringHelper;
use an602\modules\ldap\Module;
...
use an602\modules\user\authclient\interfaces\SyncAttributes;
...
use an602\modules\ldap\components\ZendLdap;
...
class LdapAuth extends BaseFormAuth implements AutoSyncUsers, SyncAttributes, ApprovalBypass, PrimaryClient
{
    ...
    /**
     * @var string the ldap query to find an602 users
     */
