...
$config['an602_root'] = isset($config['an602_root']) ? $config['an602_root'] : realpath(dirname(__DIR__ ). '/../../../');
...
\Codeception\Util\Autoload::addNamespace('', Yii::getAlias('@an602Tests/codeception/fixtures'));
