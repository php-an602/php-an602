 ...
 * @param {type} param2
 */
an602.module('ui.loader', function (module, require, $) {

    var DEFAULT_LOADER_SELECTOR = '#an602-ui-loader-default';
    ...
    var init = function () {
        $(document).on('click.an602:modules:ui:loader', '[data-ui-loader]', function (evt) {
            return module.initLoaderButton(this, evt);
        });

        $(document).on('afterValidate.an602:modules:ui:loader', function (evt, messages, errors) {
            if (errors.length) {
