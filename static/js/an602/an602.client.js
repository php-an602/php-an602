/**
 * Manages the client/server communication. Handles an602 json api responses and
 * pjax requests.
 */
an602.module('client', function (module, require, $) {
    ...
    var HEADER_VIEW_CONTEXT = 'AN602-VIEW-CONTEXT';
    ...
    var ajax = function (url, cfg, originalEvent) {
        ...
        var promise = new Promise(function (resolve, reject) {
            ...
            var success = function (data, textStatus, xhr) {
                ...
                if (response.type) {
                    event.trigger('an602:modules:client:response:' + response.type);
                }
    ...
    var onBeforeLoad = function (form, msg, msgModal) {
        ...
        $(window).on('beforeunload.an602_client', function () {
        ...
        $(document).on('pjax:beforeSend.an602_client', function (evt) {
    ...
    var offBeforeLoad = function () {
        $(window).off('beforeunload.an602_client');
        $(document).off('pjax:beforeSend.an602_client');
    };
