an602.module('ui.form.elements', function (module, require, $) {
            ...
            $match.each(function () {
                ...
                setTimeout(function() {
                    ...
                    if($formGroup.length) {
                        ...
                        var $pwShow = $('<div class="an602-pw-show"><i class="fa fa-eye"></i></div>').on('click', function() {
    ...
    FormFieldsCollapsible.component = 'an602-form-field-collapsible';
