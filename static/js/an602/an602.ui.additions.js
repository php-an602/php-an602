 ...
 */
an602.module('ui.additions', function (module, require, $) {
    ...
    var register = function (id, selector, handler, options) {
        ...
        if (!_additions[id] || options.overwrite) {
            ...
            // Make sure additions registrated after an602:ready also affect element
    ...
    var init = function () {
        ...
        $(document).on('click.an602-jp-play', '.jp-play', function () {
        ...
        $(document).on('click.an602-ui-additions', function () {
            $('.tooltip').remove();
        ...
        var observer = new MutationObserver(function (mutations) {
            mutations.forEach(function (mutation) {
                var $nodes = $(mutation.addedNodes).filter(function () {
                    return this.nodeType === 1 && !$(this).closest('.an602-ui-richtext').length; // filter out text nodes and ignore richtext changes
                });
