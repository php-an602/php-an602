/**
 * This module can be used by an602 sub modules for registering handlers and serves as core module for executing actions triggered in the gui.
 * A module can either register global handler by using the registerHandler functions or use the component mechanism.
 *
 * @namespace an602.modules.action
 */
an602.module('action', function(module, require, $) {
    ...
    Component.component = 'an602-component';
     ...
     *
     * @param {type} options
     * @returns {an602_action_L5.ActionBinding}
     */
    var ActionBinding = function(options) {
        ...
        // namespaced event e.g. click.an602-action
     ...
     *
     *  Note: When using an602.modules.client for submitting a form or sending a request and providing the action event, the event.finish will be
    ...
    ActionBinding.prototype.handle = function(options) {
        ...
        try {
            ...
            // As last resort we try to call the action by namespace for handlers like an602.modules.myModule.myAction
    ...
    var bindAction = function(parent, type, selector, directHandler, preventDefault) {
        ...
        var actionEvent = type + '.an602-action';
