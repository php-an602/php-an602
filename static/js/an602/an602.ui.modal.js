...
an602.module('ui.modal', function (module, require, $) {
    ...
    Modal.component = 'an602-ui-modal';
     ...
     * @returns {an602.ui.modal_L18.Modal.prototype@call;getContent@call;find}
     */
     ...
     * @returns {an602.ui.modal_L18.Modal.prototype@pro;$modal@call;find}
     */
    ...
    var _setGlobalModalTargetHandler = function () {
        ...
        $("a[data-target='#globalModal']").off('.an602:globalModal');

        // deprecated use action handler instead @see get action
        $(document).off('click.an602:globalModal').on('click.an602:globalModal', "a[data-target='#globalModal']", function (evt) {
            evt.preventDefault();
