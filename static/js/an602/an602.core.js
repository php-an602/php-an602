/**
 * Sets up the an602 namespace and module management.
...
var an602 = an602 || (function ($) {
    ...
    /**
     * Adds a module to the an602.modules namespace.
     *
     * The module id can be provided either as
     *
     * - full namespace an602.modules.ui.modal
     * - or modules.ui.modal
     * - or short ui.modal
     *
     * Usage:
     *
     * ```
     * an602.module('ui.modal', function(module, require, $) {...});
     * ```
     *
     ...
     *
     * ```
     * an602.module('my.LoaderWidget', function(module, require, $) {
    ...
    var createModule = function(id, instance) {
        ...
        instance.id = 'an602.modules.' + _cutModulePrefix(id);
     ...
     *
     * For the module an602.modules.ui.modal you can search:
     *
     * ```
     * require('ui.modal');
     * require('modules.ui.modal');
     * require('an602.modules.ui.modal');
     * ```
     *
     * @function module:an602.require
     * @access public
     * @param {type} moduleId
    ...
    var resolveNameSpace = function (typePath, init, warn) {
        try {
            //cut an602.modules prefix if present
    ...
    var _cutModulePrefix = function (value) {
        return _cutPrefix(_cutPrefix(value, 'an602.'), 'modules.');
    };

    /**
     * Cuts a prefix from a string, this is already available in an602.util but
    ...
    $(function() {
        ...
        an602.initialized = true;
        event.trigger('an602:ready');
        $(document).trigger('an602:ready', [false, an602]);
    });

    var initModule = function (module) {
        var log = require('log');
        event.trigger('an602:beforeInitModule', module);
        if (module.init) {
            try {
        ...
        event.trigger('an602:afterInitModule', module);
    ...
    event.on('an602:modules:client:pjax:success', function (evt) {
        ...
        event.trigger('an602:ready');
        $(document).trigger('an602:ready', [true, an602]);
    }).on('an602:modules:client:pjax:beforeSend', function (evt) {
        unloaded = [];
        $.each(moduleArr, function (i, module) {
            if (module.unload) {
                module.unload();
