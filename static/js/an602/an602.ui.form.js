an602.module('ui.form', function (module, require, $) {
    ...
    TabbedForm.component = 'an602-tabbed-form';
    ...
    var addValidationListener = function () {
        ...
        $(document).off('afterValidate.an602:ui:tabbedForm').one('afterValidate.an602:ui:tabbedForm', function (evt, messages, errors) {
    ...
    var unload = function () {
        $(document).off('afterValidate.an602:ui:tabbedForm');
    };
