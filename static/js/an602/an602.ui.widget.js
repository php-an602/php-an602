 ...
 */
an602.module('ui.widget', function (module, require, $) {
    ...
    Widget.prototype.initWidgetEvents = function () {
        ...
        $.each(this.options, function (key, value) {
            if (string.startsWith(key, 'widgetAction')) {
                ...
                that.$.on(eventType + '.an602:widget:events ' + eventType.toLowerCase + '.an602:widget:events', function () {
     ...
     */
    Widget.componentData = 'an602-widget';
