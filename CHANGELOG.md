...
1.13.0 (December 22, 2022)
--------------------------
See also: PHP-AN602 1.12 - [Release Notes](https://docs.php-an602.coders.exchange/docs/about/releasenotes/release_notes_1_13) and [Changelog](https://github.com/php-an602/php-an602/blob/master/CHANGELOG.md)
...
1.13.0-beta.2 (30 November, 2022)
---------------------------------
...
1.13.0-beta.1 (29 November, 2022)
---------------------------------
...
- Enh #5100: Added SelfTest for PHP-AN602 API connectivity
...
See also: PHP-AN602 1.12 - [Release Notes](https://docs.php-an602.coders.exchange/docs/about/releasenotes/release_notes_1_12) and [Changelog](https://github.com/php-an602/php-an602/blob/master/CHANGELOG.md)
...
1.11.4 (July 7, 2022)
---------------------
This release also fixes a [security](https://github.com/php-an602/php-an602/security/advisories/GHSA-p7h3-73v7-959c) issue. 
PHP-AN602 was vulnerable to a stored Cross-Site Scripting (XSS) vulnerability. For exploitation, the user would need a permission to administer Spaces.
...
1.11.1 (April 23, 2022)
-----------------------

See also: PHP-AN602 1.11 - [Release Notes](https://docs.php-an602.coders.exchange/docs/about/releasenotes/release_notes_1_11) and [Changelog](https://github.com/php-an602/php-an602/blob/master/CHANGELOG.md)
...
1.10.4 (April 20, 2022)
-----------------------

This release also fixes a [critical security](https://github.com/php-an602/php-an602/security/advisories/GHSA-2h35-f226-3f57) issue. Users who were forced to change their password by an administrator could perform unauthorized actions and retrieve other users' data. An update is STRONGLY recommended.
...
1.10.3 (December 21, 2021)
--------------------------

See also: [PHP-AN602 1.10 - Release Notes](https://docs.php-an602.coders.exchange/docs/about/releasenotes/release_notes_1_10) and [Changelog](https://github.com/php-an602/php-an602/blob/master/CHANGELOG.md). This release also includes a [security fix](https://github.com/php-an602/php-an602/security/advisories/GHSA-f5hc-5wfr-7v74). It could have been possible for registered users to become unauthorized members of private Spaces. Thanks to [Huntr](https://huntr.dev/bounties/943dad83-f0ed-4c74-ba81-7dfce7ca0ef2/) and @brenu.
...
1.10.2 (December 8, 2021)
-------------------------

See also: [PHP-AN602 1.10 - Release Notes](https://docs.php-an602.coders.exchange/docs/about/releasenotes/release_notes_1_10) and [Changelog](https://github.com/php-an602/php-an602/blob/master/CHANGELOG.md)
...
1.10.0-beta.3 (November 13, 2021)
---------------------------------
- Enh #5437: Tests with MySQL Galera compatibility
- Fix #5427: Fix deep comment link with enabled caching
- Enh #5435: Allow non modal links in header counter
...
1.10.0-beta.2 (November 13, 2021)
---------------------------------
...
1.9.1 (September 1, 2021)
-----------------------

See also: [PHP-AN602 1.9 - Release Notes](https://docs.php-an602.coders.exchange/docs/about/releasenotes/release_notes_1_9)
...
Note: PHP-AN602 version 1.9+ requires PHP 7.3 or higher!
...
- Fix #4838: ProsemirrorRichText::replaceLinkExtension() not compatible with PHP-AN602 < 1.8
...
1.6.4 (October 10, 2020)
-----------------------

This release also brings a [security update](https://github.com/yiisoft/yii2/security/advisories/GHSA-699q-wcff-g9mj) of the Yii2 framework. PHP-AN602 itself and the modules provided by our offical marketplace are not affected by this bug.
...
- Enh: Updated richtext version to 1.0.18 see (https://github.com/php-an602/php-an602-prosemirror/blob/master/docs/CHANGELOG.md)
...
- Fix #3674: Back button breaks layout on login page when guest access enabled
- Enh: Added `safeCreateTable`, `safeDropTable`, `safeDropColumn`, `safeAddColumn` to `humhub\components\Migration`
- Enh: Added support of upcoming PHP-AN602 Professional Edition in Marketplace module
...
1.3.18 (November 23, 2019)
--------------------------

- Fix #3698: Approval by group manager broken
- Enh: Set max signs of User tags to 250
- Fix: https://github.com/php-an602/php-an602-modules-wiki/issues/103 Topic attachment fails with given topic instances
...
- Fix: Removed Codeception files from PHP-AN602 packages builds due to possible XSS flaw (thanks to Kağan Eğlence)
- Fix #3534: Mark ID Attribute in LDAP settings as required
- Fix #3662: Group picker encode issue


1.3.12  (March 27, 2019)
---------------------------
...
- Enh: Added `PHP-AN602Helper:fetchinviteToken()` in order to fetch invite tokens from emails in functional tests
- Fix: Added "utf8mb4" character set support to database requirements
- Fix: Finnish language name in language dropdown


1.3.9  (February 14, 2019)
--------------------------
...
> Warning: Please read the [Update Guide](http://docs.php-an602.coders.exchange/admin-updating-130.html) before updating from 1.2.x!

> Note: A full list of changes is available here: [Changelog](https://github.com/php-an602/php-an602/blob/v1.3.1/protected/humhub/docs/CHANGELOG.md)
...
> Warning: Please read the [Update Guide](http://docs.php-an602.coders.exchange/admin-updating-130.html) before updating!
...
- Fix: Click to topics lead on streams without topic filter throws javascript error. (https://github.com/php-an602/php-an602-modules-polls/issues/49)
...
1.3.0-beta.2  (July 19, 2018)
-----------------------------

Please read the [Update Guide](http://docs.php-an602.coders.exchange/beta/admin-updating-130.html) before updating!

> If you're using the sources directly from GitHub, you need to build the required assets manually. Please see the chapter [Build production assets](http://docs.php-an602.coders.exchange/dev-environment.html#build-production-assets) for more details.
...
- Enh: Add possibility to delete an invitation [#2980](https://github.com/php-an602/php-an602/issues/2980)
...
- Enh: Use of new richtext version 1.0.4 see https://github.com/php-an602/php-an602-prosemirror/blob/master/docs/CHANGELOG.md 
...
- Fix #3148: Upload space picture dose not use file size setting in PHP-AN602 (acs-ferreira)
...
You can find a full list of the view changes here: https://github.com/php-an602/php-an602/commit/a1815fb61d83619ce9ca40166800b8c5dcb9d539
...
- Enh: Javascript PHP-AN602 Client - better handle ajax redirects
...
- Fix: file-preview text overflow in PHP-AN602 theme.
...
1.2.0-beta.1 (February 09, 2017)
--------------------------------
- Enh: Moved PHP-AN602 browser icons to PHP-AN602 theme (luke-)
